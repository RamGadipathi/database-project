...
-- Last modification date: 2021-12-17 00:19:04.587
...
CREATE TABLE User_Info (
    ...
    User_Infogender varchar(12) NULL,
    User_InfoAge int NULL,
    User_InfoAddress varchar(12) NULL,
    User_InfoCity varchar(12) NULL,
    User_Infostate varchar(12) NOT NULL,
    User_InfoZipCode int NOT NULL,
    User_Infocountry varchar(12) NOT NULL,
